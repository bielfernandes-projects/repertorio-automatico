...
export const SongDocumentsModal: React.FC<SongDocumentsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      <div className="bg-zinc-900 dark:bg-[#120c24] border border-purple-500/30 dark:border-purple-500/30 rounded-3xl w-full max-w-lg overflow-hidden shadow-2xl flex flex-col max-h-[85vh]">
        {/* Modal Header */}
        <div className="px-5 py-4 border-b border-purple-900/40 dark:border-purple-900/40 flex items-center justify-between bg-zinc-950/60 dark:bg-[#090714]/60">
