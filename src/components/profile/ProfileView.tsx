...
export const ProfileView: React.FC<ProfileViewProps> = ({ onLogout }) => {
  ...
  return (
    <div className="p-4 sm:p-6 md:p-8 space-y-5 pb-24 animate-in fade-in duration-200">
      ...
      <div className="space-y-4">
        ...
        <div className="space-y-2">
          ...
          {userSetlists.length === 0 ? (
            <div className="bg-white/50 dark:bg-[#120c24]/50 border border-zinc-200 dark:border-purple-900/40 rounded-2xl p-4 text-center">
            ...
            <div className="space-y-2">
              {userSetlists.map((st) => (
                <div
                  key={st.id}
                  className="bg-white dark:bg-[#120c24] border border-zinc-200 dark:border-purple-900/40 rounded-2xl p-3.5 flex flex-col sm:flex-row sm:items-center justify-between gap-3 shadow-sm"
                >
                  <div>
      ...
      <div className="bg-white dark:bg-[#120c24] border border-zinc-200 dark:border-purple-900/40 rounded-2xl p-4 space-y-3 shadow-sm">
