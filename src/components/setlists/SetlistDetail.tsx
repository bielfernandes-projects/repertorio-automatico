    ...
    <div className="p-4 pb-24 sm:p-6 sm:pb-24 md:p-8 md:pb-32 space-y-4 animate-in fade-in duration-200">
      ...
      <div className="space-y-3">
        ...
        {filteredBlocks.length === 0 ? (
          <div className="bg-white/50 dark:bg-[#120c24]/50 border border-zinc-200 dark:border-purple-900/40 rounded-2xl p-6 text-center space-y-2">
            ...
            {filteredBlocks.map((block, index) => {
              ...
              return (
                <div
                  ...
                  className="group bg-white dark:bg-[#120c24] hover:border-purple-400 dark:hover:border-purple-500/60 border border-zinc-200 dark:border-purple-900/40 rounded-2xl p-4 transition-all duration-200 cursor-pointer shadow-sm dark:shadow-md active:scale-[0.99] space-y-2.5"
                >
