...
const SEED_SETLISTS: Setlist[] = [
  {
    ...
    ownerEmail: DEFAULT_USER.email,
    name: 'Barzinho Sexta-Feira',
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
    members: [],
    blocks: [
      {
        id: 'block_01',
        setlistId: 'setlist_01',
        name: 'Abertura Acústica',
        theme: 'Pop Rock Leve',
        position: 0,
        items: [
          {
            id: 'item_01',
            blockId: 'block_01',
            catalogSongId: 'song_01', // Wonderwall
            requestedKey: 'F#m',
            position: 0,
            originalKeyAtAssignment: 'Em'
          },
          {
            id: 'item_02',
            blockId: 'block_01',
            catalogSongId: 'song_04', // Anunciação
            requestedKey: 'G',
            position: 1,
            originalKeyAtAssignment: 'G'
          },
          {
            id: 'item_03',
            blockId: 'block_01',
            catalogSongId: 'song_05', // Tempo Perdido
            requestedKey: 'D',
            position: 2,
            originalKeyAtAssignment: 'C'
          }
        ]
      },
      {
        ...
        items: [
          {
            id: 'item_04',
            blockId: 'block_02',
            catalogSongId: 'song_02', // Cheia de Manias
            requestedKey: 'Dm',
            position: 0,
            originalKeyAtAssignment: 'C#m'
          },
          {
            id: 'item_05',
            blockId: 'block_02',
            catalogSongId: 'song_07', // Gostava Tanto de Você
            requestedKey: 'A',
            position: 1,
            originalKeyAtAssignment: 'A'
          }
        ]
      },
      {
        id: 'block_03',
        setlistId: 'setlist_01',
        name: 'O Clássico Hino',
        theme: 'Sertanejo Raíz',
        position: 2,
        items: [
          {
            id: 'item_06',
            blockId: 'block_03',
            catalogSongId: 'song_03', // Evidências
            requestedKey: 'F',
            position: 0,
            originalKeyAtAssignment: 'E'
          }
        ]
      }
    ]
        ...
        items: [
          {
            id: 'item_10',
            blockId: 'block_10',
            catalogSongId: 'song_06', // Sozinho
            requestedKey: 'D',
            position: 0,
            originalKeyAtAssignment: 'D'
          }
        ]
      }
    ]
